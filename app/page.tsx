...
// 完整高效簡繁轉換映射字典 (覆蓋常用字、標點、動漫/影視/名言高頻字)
const s2tDict: Record<string, string> = {
  "万": "萬", "与": "與", "丑": "醜", "专": "專", "丝": "絲", "两": "兩", "严": "嚴", "丧": "喪",
  "个": "個", "临": "臨", "为": "為", "丽": "麗", "举": "舉", "么": "麼", "义": "義", "乌": "烏",
  "乐": "樂", "乔": "喬", "习": "習", "书": "書", "买": "買", "乱": "亂", "争": "爭", "于": "於",
  "亏": "虧", "亚": "亞", "产": "產", "亲": "親", "亿": "億", "什": "什", "从": "從", "仑": "侖",
  "仓": "倉", "仪": "儀", "们": "們", "价": "價", "众": "眾", "优": "優", "伙": "夥", "会": "會",
  "伟": "偉", "传": "傳", "伤": "傷", "伦": "倫", "伪": "偽", "体": "體", "余": "餘", "佣": "傭",
  "佩": "佩", "佰": "佰", "佳": "佳", "併": "併", "来": "來", "保": "保", "侠": "俠", "信": "信",
  "修": "修", "俱": "俱", "倍": "倍", "倒": "倒", "借": "借", "倦": "倦", "倾": "傾", "假": "假",
  "偏": "偏", "停": "停", "健": "健", "偶": "偶", "偿": "償", "傀": "傀", "傅": "傅", "傍": "傍",
  "杰": "傑", "备": "備", "催": "催", "傲": "傲", "债": "債", "傻": "傻", "像": "像", "僚": "僚",
  "侥": "僥", "僧": "僧", "僭": "僭", "僮": "僮", "仆": "僕", "嘻": "嘻", "僾": "僾", "亿": "億",
  "木": "木", "本": "本", "术": "術", "朴": "樸", "机": "機", "杀": "殺", "杂": "雜", "权": "權",
  "极": "極", "构": "構", "林": "林", "果": "果", "枝": "枝", "枢": "樞", "枣": "棗", "枪": "槍",
  "枫": "楓", "枭": "梟", "柜": "櫃", "柠": "檸", "查": "查", "柬": "柬", "柯": "柯", "柱": "柱",
  "柳": "柳", "柴": "柴", "栅": "柵", "标": "標", "栈": "棧", "栋": "棟", "栏": "欄", "树": "樹",
  "栖": "棲", "栗": "栗", "校": "校", "株": "株", "样": "樣", "核": "核", "根": "根", "格": "格",
  "栽": "栽", "桂": "桂", "桃": "桃", "框": "框", "案": "案", "桌": "桌", "桐": "桐", "桑": "桑",
  "桓": "桓", "桔": "桔", "桥": "橋", "桧": "檜", "浆": "漿", "桨": "槳", "桩": "樁", "桶": "桶",
  "梁": "梁", "梅": "梅", "梦": "夢", "梧": "梧", "梨": "梨", "梭": "梭", "梯": "梯", "械": "械",
  "梳": "梳", "梵": "梵", "检": "檢", "棉": "棉", "棋": "棋", "棍": "棍", "棒": "棒", "棕": "棕",
  "棚": "棚", "棠": "棠", "森": "森", "棱": "稜", "棵": "棵", "椭": "橢", "楼": "樓", "榄": "欖",
  "榆": "榆", "脚": "腳", "脸": "臉", "脑": "腦", "脱": "脫", "腊": "臘", "腐": "腐", "腑": "腑",
  "腓": "腓", "腔": "腔", "腕": "腕", "腥": "腥", "肿": "腫", "腮": "腮", "腰": "腰", "腱": "腱",
  "肠": "腸", "腹": "腹", "腺": "腺", "腿": "腿", "膀": "膀", "膂": "膂", "膈": "膈", "膊": "膊",
  "膏": "膏", "膑": "臏", "肤": "膚", "膛": "膛", "膜": "膜", "膝": "膝", "胶": "膠", "膨": "膨",
  "腻": "膩", "膳": "膳", "膺": "膺", "胆": "膽", "脍": "膾", "脓": "膿", "臀": "臀", "臂": "臂",
  "臆": "臆", "脐": "臍", "臲": "臲", "舱": "艙", "舰": "艦", "艰": "艱", "艳": "艷", "艺": "藝",
  "节": "節", "范": "範", "芒": "芒", "芦": "蘆", "苏": "蘇", "苹": "蘋", "茎": "莖", "茧": "繭",
  ...
  "莺": "鶯", "莽": "莽", "莫": "莫", "莱": "萊", "莲": "蓮", "莴": "萵", "获": "獲", "莹": "瑩",
  "莼": "蓴", "菊": "菊", "菌": "菌", "菜": "菜", "菠": "菠", "菩": "菩", "华": "華", "菱": "菱",
  "菲": "菲", "萨": "薩", "萤": "螢", "乾": "乾", "説": "說", "爱": "愛", "点": "點", "线": "線",
  "话": "話", "说": "說", "这": "這", "还": "還", "进": "進", "国": "國", "风": "風", "龙": "龍",
  "门": "門", "长": "長", "见": "見", "发": "發", "头": "頭", "关": "關", "东": "東", "车": "車",
  "马": "馬", "鸟": "鳥", "时": "時", "间": "間", "过": "過", "对": "對", "开": "開", "问": "問",
  "动": "動", "产": "產", "业": "業", "经": "經", "给": "給", "认": "認", "为": "為", "样": "樣",
  "种": "種", "调": "調", "变": "變", "单": "單", "现": "現", "实": "實", "难": "難", "乐": "樂",
  "欢": "歡", "让": "讓", "导": "導", "写": "寫", "听": "聽", "视": "視", "频": "頻", "网": "網",
  "红": "紅", "绿": "綠", "蓝": "藍", "级": "級", "组": "組", "织": "織", "终": "終", "细": "細",
  "绝": "絕", "统": "統", "绘": "繪", "给": "給", "络": "絡", "骆": "駱", "骑": "騎", "骗": "騙",
  "骄": "驕", "验": "驗", "惊": "驚", "体": "體", "魂": "魂", "鸣": "鳴", "鸭": "鴨", "鸿": "鴻",
  "鹃": "鵑", "鹅": "鵝", "莺": "鶯", "鹤": "鶴", "鹰": "鷹", "鹿": "鹿", "麦": "麥", "麻": "麻",
  "黄": "黃", "黍": "黍", "黑": "黑", "默": "默", "齐": "齊", "齿": "齒", "龙": "龍", "龟": "龜",
  "兰": "蘭", "凭": "憑", "别": "別", "胜": "勝", "劳": "勞", "势": "勢", "叹": "嘆", "图": "圖",
  "压": "壓", "坏": "壞", "坚": "堅", "报": "報", "场": "場", "块": "塊", "声": "聲", "处": "處",
  "备": "備", "复": "復", "头": "頭", "夺": "奪", "奖": "獎", "妇": "婦", "寻": "尋", "带": "帶",
  "广": "廣", "庄": "莊", "庆": "慶", "废": "廢", "强": "強", "当": "當", "录": "錄", "微": "微",
  "德": "德", "志": "志", "念": "念", "态": "態", "怜": "憐", "总": "總", "悲": "悲", "情": "情",
  "想": "想", "意": "意", "感": "感", "愿": "願", "戏": "戲", "战": "戰", "才": "才", "执": "執",
  "扫": "掃", "护": "護", "报": "報", "担": "擔", "据": "據", "择": "擇", "摆": "擺", "无": "無",
  "时": "時", "易": "易", "星": "星", "显": "顯", "晓": "曉", "极": "極", "构": "構", "样": "樣",
  "次": "次", "欢": "歡", "步": "步", "死": "死", "残": "殘", "段": "段", "母": "母", "毒": "毒",
  "气": "氣", "水": "水", "求": "求", "汉": "漢", "汐": "汐", "汗": "汗", "汝": "汝", "江": "江",
  "池": "池", "污": "污", "汤": "湯", "汪": "汪", "决": "決", "沉": "沉", "沐": "沐", "沛": "沛",
  "没": "沒", "冲": "沖", "沙": "沙", "沫": "沫", "河": "河", "油": "油", "治": "治", "沿": "沿",
  "泉": "泉", "泊": "泊", "泓": "泓", "法": "法", "泛": "泛", "泞": "濘", "泡": "泡", "波": "波",
  "泣": "泣", "泥": "泥", "注": "注", "泪": "淚", "洗": "洗", "洋": "洋", "洛": "洛", "洞": "洞",
  "津": "津", "洪": "洪", "洲": "洲", "活": "活", "洽": "洽", "派": "派", "流": "流", "浅": "淺",
  "浙": "浙", "浚": "浚", "浜": "浜", "浣": "浣", "浩": "浩", "浪": "浪", "浮": "浮", "海": "海",
  "消": "消", "涉": "涉", "涌": "湧", "涓": "涓", "涛": "濤", "涝": "澇", "涟": "漣", "涡": "渦",
  "涤": "滌", "润": "潤", "涨": "漲", "涩": "澀", "涣": "渙", "渐": "漸", "渔": "漁", "渗": "滲",
  "温": "溫", "湾": "灣", "湿": "濕", "溃": "潰", "溅": "濺", "惨": "慘", "惭": "慚", "慢": "慢"
};

// 100% 精準強制簡轉繁演算法
const forceToTC = (text: string) => {
  if (!text) return "";
  return text
    .split("")
    .map((char) => s2tDict[char] || char)
    .join("");
};
...
export default function Home() {
  ...
  const fetchRandomQuote = async () => {
    ...
    try {
      ...
      if (data && data.hitokoto) {
        // 強制實時即時簡轉繁
        const tcQuote = forceToTC(data.hitokoto);
        const tcFromWho = data.from_who ? forceToTC(data.from_who) : "";
        const tcFrom = data.from ? forceToTC(data.from) : "";

        const tcAuthor = tcFromWho
          ? `@${tcFromWho}《${tcFrom}》`
          : tcFrom
          ? `@《${tcFrom}》`
          : "@NotionSnap";

        handleTextChange(tcQuote);
        handleAuthorChange(tcAuthor);
      }
    } catch (err) {
  ...
  useEffect(() => {
    ...
    if (savedText) {
      setText(forceToTC(savedText));
      setAuthor(savedAuthor ? forceToTC(savedAuthor) : "@NotionSnap");
    } else {
      fetchRandomQuote();
    }
  }, []);
  ...
  const handleTextChange = (val: string) => {
    const tcVal = forceToTC(val);
    setText(tcVal);
    localStorage.setItem("notionsnap_text", tcVal);
  };

  const handleAuthorChange = (val: string) => {
    const tcVal = forceToTC(val);
    setAuthor(tcVal);
    localStorage.setItem("notionsnap_author", tcVal);
  };
